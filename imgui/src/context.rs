...
impl Context {
    ...
    pub fn set_clipboard_backend<T: ClipboardBackend>(&mut self, backend: T) {
        ...
        let platform_io = unsafe {
            ...
            &mut *(crate::ig_get_platform_io() as *mut crate::PlatformIo)
        };
...
impl Context {
    ...
    pub fn platform_io(&self) -> &crate::PlatformIo {
        unsafe {
            ...
            &*(crate::ig_get_platform_io() as *const crate::PlatformIo)
        }
    }
